...
import com.myomdbapplication.connectivity.ConnectivityProvider.ConnectivityState.ConnectedState.ConnectedLegacy
import com.myomdbapplication.connectivity.ConnectivityProvider.ConnectivityState.NotConnectedState
...
class ConnectivityProviderLegacyImpl(
    ...
    override fun getNetworkState(): ConnectivityState {
